  ...
  module Articles
    module Backend
      class ArticlesController < Erp::Backend::BackendController
        before_action :set_article, only: [:archive, :unarchive, :show, :edit, :update, :destroy]
        ...
        private
          ...
          def article_params
            params.fetch(:article, {}).permit(:image, :name, :content, :meta_keyword, :meta_description, :tags, :category_id)
          end
      end
    end
  end
