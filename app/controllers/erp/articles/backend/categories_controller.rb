  ...
  module Articles
    module Backend
      class CategoriesController < Erp::Backend::BackendController
        before_action :set_category, only: [:archive, :unarchive, :show, :edit, :update, :destroy, :move_up, :move_down]
        ...
        private
          ...
          def category_params
            params.fetch(:category, {}).permit(:name, :description, :parent_id, :alias, :disable_submenu, :note, :style_icon, :only_show_image)
          end
      end
    end
  end
